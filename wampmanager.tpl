...
{$RunAtStart}Action: run; FileName: "{$c_navigator}"; Parameters: "{$c_edge}{$localhostHTTP}://localhost{$UrlPort}/"; ShowCmd: normal; Flags: ignoreerrors
...
Type: item; Caption: "{$w_helpUse}"; Action: TextKey; Glyph: 35
Type: item; Caption: "{$w_NeedVirtualhost}"; Action: TextKey; Glyph: 35
Type: item; Caption: "{$w_phpMyAdminHelp}"; Action: TextKey; Glyph: 35
Type: item; Caption: "{$w_MariaDBMySQLHelp}"; Action: TextKey; Glyph: 35
Type: item; Caption: "{$w_wampHttpsHelp}"; Action: TextKey; Glyph: 35
Type: item; Caption: "{$w_Refresh_Restart}"; Action: TextKey; Glyph: 35
Type: item; Caption: "{$w_addingVer}"; Action: TextKey; Glyph: 35
...
[wampreload]
;WAMPRELOADSTART
Action: run; FileName: "{$c_phpExe}";Parameters: "switchPhpVersion.php {$c_phpVersion}";WorkingDir: "{$c_installDir}/scripts"; Flags: waituntilterminated; ShowCmd: hidden
...
Type: item; Caption: "{$w_localhost}"; Action: run; FileName: "{$c_navigator}"; Parameters: "{$c_edge}{$localhostHTTP}://localhost{$UrlPort}/"; Glyph: 27
;WAMPPHPMYADMIN
{$SupportDBMS}{$adminerMenu}Type: item; Caption: "Adminer {$Alias_Contents['adminer']['version']}{$Alias_Contents['adminer']['fcgiaff']}"; Action: run; FileName: "{$c_navigator}"; Parameters: "{$c_edge}{$localhostHTTP}://localhost{$UrlPort}/adminer/"; Glyph: 40
;WAMPVHOSTSUBMENU
;WAMPALIASSUBMENU
...
Action: run; FileName: "{$c_phpExe}"; parameters: "msg.php refreshLogs alllogs automatic";WorkingDir: "$c_installDir/scripts"; Flags: waituntilterminated; ShowCmd: hidden
...
Action: run; FileName: "{$c_phpExe}"; Parameters: "testPortForInstall.php";WorkingDir: "{$c_installDir}/scripts"; Flags: waituntilterminated; ShowCmd: hidden
...
Action: run; FileName: "{$c_phpExe}"; Parameters: "switchWampPort.php %ApachePort%";WorkingDir: "{$c_installDir}/scripts"; Flags: waituntilterminated; ShowCmd: hidden
Action: multi; Actions: apache_restart_refresh; Flags:appendsection
;WAMPALTERNATEPORTEND

[AddListenPort]
;WAMPADDLISTENPORTSTART
Action: run; FileName: "{$c_phpExe}"; Parameters: "ListenPortApache.php add %AddListenApachePort%";WorkingDir: "{$c_installDir}/scripts"; Flags: waituntilterminated; ShowCmd: normal
Action: multi; Actions: apache_restart_refresh; Flags:appendsection
...
Action: run; FileName: "{$c_phpExe}"; Parameters: "refresh.php doreport";WorkingDir: "{$c_installDir}/scripts"; Flags: waituntilterminated; ShowCmd: hidden
Action: readconfig
